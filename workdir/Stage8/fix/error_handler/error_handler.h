...
enum Error {
    ...
    E_USE_OF_NON_PRIMITIVE_TYPE_IN_TUPLE,
    E_DUPLICATE_FIELD_IN_TUPLE,
    ...
    // Class / OOPs
    E_CLASS_USED_BEFORE_DECLARATION = 1000,
    E_INVALID_SIZE_FOR_CLASS,
    E_ACCESS_NON_EXISTING_FIELD_OF_CLASS,
    E_METHOD_CALLED_ON_NON_CLASS_VARIABLE,
    E_CALL_NON_EXISTING_METHOD_OF_CLASS,
    E_CLASS_REDECLARATION
};
