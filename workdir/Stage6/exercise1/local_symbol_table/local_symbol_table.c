...
static LSymbol *createLSTEntry(char *name, enum Type type, bool isPtr, bool isParam, struct TupleType *tupleType, struct TypeTable *typeTableEntry) {
...
struct LSymbol *installLST(char *name, enum Type type, bool isParam, bool isPtr, struct TupleType *tupleType, struct TypeTable *typeTableEntry) {
