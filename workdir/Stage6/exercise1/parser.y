...
%type <node> globalDeclBlock globalDeclList globalDecl globalTupleDecl globalVarList
...
globalDeclBlock : KW_DECL globalDeclList KW_ENDDECL                 { printGST(); $$ = NULL; }
    | KW_DECL KW_ENDDECL                                            { $$ = NULL; }
    ;

globalDeclList : globalDeclList globalDecl                          { $$ = NULL; }
    | globalDecl                                                    { $$ = NULL; }
    ;

globalDecl : type globalVarList SEMI                                { addToGST($1, $2); $$ = NULL; }
    | globalTupleDecl SEMI                                          { $$ = NULL; }
    ;
...
globalTupleDecl : KW_TUPLE ID '(' tupleFieldList ')' tupleIdList    { addTupleTypeToGST($2, $4, $6); $$ = NULL; }
    ;
...
mainBlock : TYPE_INT MAIN '(' ')' '{' localDeclBlock body '}'       { generateMainCode($7); printLocalSymbolTable(); 
