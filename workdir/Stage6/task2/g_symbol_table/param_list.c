...
static struct Param *createParam(char *name, int type, bool isPtr, struct TupleType *tupleType, struct TypeTable *typeTableEntry) {
...
struct Param *addParam(struct GSymbol *GSymbolTableEntry, char *name, int type, bool isPtr, struct TupleType *tupleType, struct TypeTable *typeTableEntry) {
