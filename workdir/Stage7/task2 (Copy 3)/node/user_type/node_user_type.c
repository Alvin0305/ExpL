    ...
    switch (baseExprNode->nodeType) {
            ...
            switch (baseIdNode->type) {
                ...
                case CLASS:
                    if (isMethodCall) {
                        ...
                        printf("%s is class. on calling method %s, new active type is: %s\n", baseIdNode->varName,
                               memberIdNode->varName, activeClass ? activeClass->name : activeUserType->name);
                    ...
                    if (activeClass) {
                        ...
                        printf("%s is class. on offsetting %s, new active type is: %s\n", baseIdNode->varName,
                               memberIdNode->varName, activeClass->name);
        ...
        default:
            if (isMethodCall) {
                ...
                printf("on calling method %s, new active type is: %s\n", memberIdNode->varName,
                       activeClass ? activeClass->name : activeUserType->name);
